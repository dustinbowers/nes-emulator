...
pub fn render(ctx: &Context, texture: &mut Option<TextureHandle>, frame: &SharedFrame, paused: bool) {
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        let tex = texture.get_or_insert_with(|| {
            ui.ctx().load_texture("nes_frame", color_image.clone(), TextureOptions::LINEAR)
        });
