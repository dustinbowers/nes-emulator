    ...
    pub fn new() -> Self {
        Self {
            ...
            default_map: vec![
                ...
                Color::from([0.78, 0.78, 0.7, 1.0]),
                Color::from([0.51, 0.51, 0.51, 1.0]),
                Color::from([0.32, 0.32, 0.32, 1.0]),
                // Color::from([1.0, 0.0, 0.0, 0.0]),
                Color::from([1.0, 0.5, 0.0, 1.0]),
                Color::from([1.0, 1.0, 0.0, 1.0]),
                Color::from([1.0, 1.0, 0.0, 1.0]),
                Color::from([0.5, 1.0, 0.0, 1.0]),
                Color::from([0.0, 1.0, 0.0, 1.0]),
                Color::from([0.0, 1.0, 0.5, 1.0]),
                Color::from([0.0, 1.0, 1.0, 1.0]),
                Color::from([0.0, 0.5, 1.0, 1.0]),
                Color::from([0.0, 0.0, 1.0, 1.0]),
                Color::from([0.5, 0.0, 1.0, 1.0]),
                Color::from([1.0, 0.0, 1.0, 1.0]),
                Color::from([1.0, 0.0, 0.5, 1.0]),
